...
export declare const animations: unique symbol;
...
export declare const customElementDefineCallback: unique symbol;
export declare const onCustomElementConnected: unique symbol;
export declare const addIdentifierToWindow: unique symbol;
export declare const removeIdentifierFromWindow: unique symbol;
export declare const onSlotChange: unique symbol;
...
export declare const customElementUpgradeTarget: unique symbol;
...
export declare const getPropertyManager: unique symbol;
export declare const clearComputedStyleCache: unique symbol;
