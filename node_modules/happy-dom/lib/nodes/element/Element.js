...
export default class Element extends Node {
    ...
    constructor() {
        ...
        if (this.constructor[PropertySymbol.customElementUpgradeTarget]) {
            return this.constructor[PropertySymbol.customElementUpgradeTarget];
        }
    ...
    animate(keyframes, options = {}) {
        ...
        const animation = new this[PropertySymbol.window].Animation(effect, this[PropertySymbol.ownerDocument].timeline);
     ...
     * @param id Identifier.
     */
    [PropertySymbol.addIdentifierToWindow](id) {
        if (!id) {
            return;
        }
     ...
     * @param id Identifier.
     */
    [PropertySymbol.removeIdentifierFromWindow](id) {
        if (!id) {
            return;
        }
        const document = this[PropertySymbol.ownerDocument];
     ...
     */
    [PropertySymbol.onSlotChange](addedOrRemovedNode) {
        const shadowRoot = this[PropertySymbol.shadowRoot];
