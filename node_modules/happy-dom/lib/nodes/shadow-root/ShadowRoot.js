...
export default class ShadowRoot extends DocumentFragment {
    ...
    set adoptedStyleSheets(value) {
        if (!Array.isArray(value)) {
            throw new this[PropertySymbol.window].TypeError(`Failed to set the 'adoptedStyleSheets' property on 'ShadowRoot': The provided value cannot be converted to a sequence.`);
        }
        for (const sheet of value) {
            if (!(sheet instanceof this[PropertySymbol.window].CSSStyleSheet)) {
                throw new this[PropertySymbol.window].TypeError(`Failed to set the 'adoptedStyleSheets' property on 'ShadowRoot': Failed to convert value to 'CSSStyleSheet'.`);
            }
        }
