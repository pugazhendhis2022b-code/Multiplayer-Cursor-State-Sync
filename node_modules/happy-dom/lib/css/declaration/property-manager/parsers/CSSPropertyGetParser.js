...
export default class CSSPropertyGetParser {
    ...
    static getOutline(properties) {
        ...
        if (CSSValueFormatter.getGlobalExceptInitial(properties['outline-width'].value) &&
    ...
    static getBorder(properties) {
        ...
        if (CSSValueFormatter.getGlobalExceptInitial(properties['border-top-width'].value) ||
    ...
    static getBorderImage(properties) {
        ...
        const important = properties['border-image-source'].important &&
            ...
            properties['border-image-outset'].important &&
            properties['border-image-repeat'].important;
        if (CSSValueFormatter.getGlobal(properties['border-image-source'].value) ||
    ...
    static getBackground(properties) {
        ...
        if (CSSValueFormatter.getGlobalExceptInitial(properties['background-image'].value) ||
        ...
        if (!CSSValueFormatter.getInitial(properties['background-position-x'].value) &&
        ...
        else if (!CSSValueFormatter.getInitial(properties['background-position-x'].value) &&
            !CSSValueFormatter.getInitial(properties['background-position-y'].value)) {
    ...
    static getBackgroundPosition(properties) {
        ...
        const important = properties['background-position-x'].important &&
            properties['background-position-y'].important;
        if (CSSValueFormatter.getGlobal(properties['background-position-x'].value) ||
    ...
    static getFlex(properties) {
        ...
        if (CSSValueFormatter.getGlobal(properties['flex-grow'].value) ||
    ...
    static getFont(properties) {
        ...
        if (CSSValueFormatter.getGlobal(properties['font-size'].value) ||
    ...
    static getBorderTopRightBottomLeft(position, properties) {
        ...
        if (CSSValueFormatter.getGlobalExceptInitial(properties[`border-${position}-width`].value) &&
    ...
    static getPaddingLikeProperty(propertyNames, properties) {
        ...
        if (CSSValueFormatter.getGlobal(properties[propertyNames[0]].value) ||
...
//# sourceMappingURL=CSSPropertyGetParser.js.map