...
export default class CSSPropertySetParser {
     ...
     */
    static getDefault(name, value, important) {
        const parsedValue = CSSVariableFormatter.getVariable(value) || CSSValueFormatter.getGlobal(value) || value;
    ...
    static getLetterSpacing(value, important) {
        const parsedValue = CSSVariableFormatter.getVariable(value) ||
    ...
    static getOutlineColor(value, important) {
        const color = CSSVariableFormatter.getVariable(value) ||
            CSSValueFormatter.getGlobal(value) ||
    ...
    static getOutlineOffset(value, important) {
        const parsedValue = CSSVariableFormatter.getVariable(value) || CSSValueFormatter.getLength(value);
    ...
    static getOutlineWidth(value, important) {
        ...
        const lowerValue = value.toLowerCase();
        const parsedValue = BORDER_WIDTH.includes(lowerValue) || CSSValueFormatter.getGlobal(lowerValue)
            ? lowerValue
    ...
    static getMarginTop(value, important) {
        ...
        const margin = CSSValueFormatter.getGlobal(value) || CSSValueFormatter.getAutoMeasurement(value);
    ...
    static getBackgroundSize(value, important) {
        ...
        for (const imagePart of imageParts) {
            ...
            if (parts.length === 1) {
                ...
                if (!CSSValueFormatter.getAutoMeasurement(parts[0]) ||
    ...
    static getBackgroundImage(value, important) {
        ...
        const parsed = [];
        for (const part of parts) {
            const parsedValue = CSSValueFormatter.getURL(part.trim()) || CSSValueFormatter.getGradient(part.trim());
            if (!parsedValue) {
                return null;
            }
    ...
    static getTextTransform(value, important) {
        ...
        const lowerValue = value.toLowerCase();
        const parsedValue = CSSValueFormatter.getGlobal(lowerValue) ||
    ...
    static getVisibility(value, important) {
        ...
        const lowerValue = value.toLowerCase();
        const parsedValue = CSSValueFormatter.getGlobal(lowerValue) || (VISIBILITY.includes(lowerValue) && lowerValue);
        if (parsedValue) {
            return {
...
//# sourceMappingURL=CSSPropertySetParser.js.map